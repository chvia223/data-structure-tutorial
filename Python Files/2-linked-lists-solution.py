...
# appendleft acts as our insert_head function and will put an
# element at the beginning of a linked list.
music_queue.appendleft("Drivers License")
...
# You can use del music_queue[3] to delete the "Therefore I Am" node, but the Python implementation
# has a remove method that will search for any entries with the value you pass and delete the first
# one it finds. 
song = music_queue[3]
music_queue.remove("Therefore I Am")
music_queue.insert(1, song)
